...
export default function MBBSInfoPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      {/* Government Notices Dropdown Widget */}
      <div className="fixed right-4 top-48 z-50 hidden xl:block">
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-80 overflow-hidden">
          {/* Dropdown Header */}
          <button
            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
            className="w-full bg-gradient-to-r from-red-600 to-red-700 p-4 text-white hover:from-red-700 hover:to-red-800 transition-colors"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <Info className="h-5 w-5 mr-2" />
                <h3 className="font-bold text-lg">Government Notices</h3>
              </div>
              <ChevronDown 
          ...
          {/* Dropdown Content */}
          <div className={`transition-all duration-300 ease-in-out ${isDropdownOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
            <div className="p-4 space-y-3 max-h-[500px] overflow-y-auto">
              {/* Notice 1 */}
              <div className="bg-red-50 border-l-4 border-red-500 rounded-r-lg p-3 hover:bg-red-100 transition-colors cursor-pointer">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm text-red-800 mb-1">DGME Notice 2024</h4>
                    <p className="text-xs text-gray-600 mb-2">Admission guidelines for 2024-2025</p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">Sep 15, 2024</span>
                      <Button variant="ghost" size="sm" className="text-red-600 hover:bg-red-100 p-1">
              ...
              {/* Notice 2 */}
              <div className="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-3 hover:bg-blue-100 transition-colors cursor-pointer">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm text-blue-800 mb-1">BMDC Recognition</h4>
                    <p className="text-xs text-gray-600 mb-2">Program accreditation status</p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">Valid until Dec 2025</span>
                      <Button variant="ghost" size="sm" className="text-blue-600 hover:bg-blue-100 p-1">
                        <Download className="h-3 w-3" />
                      </Button>
                    </div>
                  </div>
              ...
              {/* Notice 3 */}
              <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3 hover:bg-green-100 transition-colors cursor-pointer">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm text-green-800 mb-1">Health Ministry</h4>
                    <p className="text-xs text-gray-600 mb-2">Quota allocation guidelines</p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">Oct 1, 2024</span>
                      <Button variant="ghost" size="sm" className="text-green-600 hover:bg-green-100 p-1">
                        <Download className="h-3 w-3" />
                      </Button>
                    </div>
                  </div>
              ...
              {/* Notice 4 */}
              <div className="bg-orange-50 border-l-4 border-orange-500 rounded-r-lg p-3 hover:bg-orange-100 transition-colors cursor-pointer">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm text-orange-800 mb-1">COVID-19 Protocol</h4>
                    <p className="text-xs text-gray-600 mb-2">Health admission guidelines</p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-500">Sep 30, 2024</span>
                      <Button variant="ghost" size="sm" className="text-orange-600 hover:bg-orange-100 p-1">
                        <Download className="h-3 w-3" />
                      </Button>
                    </div>
                  </div>
      ...
      {/* Mobile Government Notices */}
      <div className="bg-gradient-to-b from-gray-50 to-white py-16 xl:hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Official notices and guidelines from regulatory authorities
              </p>
            </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <div>
                          <h3 className="font-bold text-red-800">DGME Notice 2024</h3>
                          <p className="text-sm text-gray-500">Directorate General of Medical Education</p>
                        </div>
                      </div>
                      <p className="text-gray-700 text-sm mb-3">
                        Admission guidelines for the academic year 2024-2025
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500">Published: September 15, 2024</span>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <div>
                          <h3 className="font-bold text-blue-800">BMDC Recognition</h3>
                          <p className="text-sm text-gray-500">Bangladesh Medical & Dental Council</p>
                        </div>
                      </div>
                      <p className="text-gray-700 text-sm mb-3">
                        Full program recognition and graduate eligibility
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500">Valid until: December 31, 2025</span>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <div>
                          <h3 className="font-bold text-green-800">Health Ministry</h3>
                          <p className="text-sm text-gray-500">Ministry of Health and Family Welfare</p>
                        </div>
                      </div>
                      <p className="text-gray-700 text-sm mb-3">
                        Updated quota allocation guidelines for reserved categories
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500">Updated: October 1, 2024</span>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <div>
                          <h3 className="font-bold text-orange-800">COVID-19 Protocol</h3>
                          <p className="text-sm text-gray-500">Health Directorate Advisory</p>
                        </div>
                      </div>
                      <p className="text-gray-700 text-sm mb-3">
                        Special admission guidelines and health protocols
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500">Last updated: September 30, 2024</span>
